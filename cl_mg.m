function [C, obj_value, data] = cl_mg(data, nbclusters, varargin)
%
...
for i = 1:nitners
    ...
    obj_value(i) = tmp + eta * norm(cell2mat(F_v) - Y*C)^2;
...
% fix Y and C
% fix alpha, need more coding here
